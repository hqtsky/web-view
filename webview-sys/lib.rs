...
extern {
	...
	pub fn wrapper_webview_new(title: *const c_char, url: *const c_char, width: c_int, height: c_int, resizable: c_int, debug: c_int, titlebar_transparent: c_int, external_invoke_cb: Option<ErasedExternalInvokeFn>, userdata: *mut c_void) -> *mut CWebView;
  ...
  pub fn webview_set_background_color(this: *mut CWebView, r: c_float, g: c_float, b: c_float, a: c_float);
}
